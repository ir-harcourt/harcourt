...
class scsps_toolbox_class {
    ...
    function json_curl_ipv4() {
	    ...
	    curl_setopt($this->curl_ch, CURLOPT_URL, "https://scscpq.com/scs_ipv4.php");
	 //   curl_setopt($this->curl_ch, CURLOPT_URL, "http://localhost:8114/scs_ipv4.php");
	//    curl_setopt($this->curl_ch, CURLOPT_URL, "https://ip.hetzner.com");
...
/*
    [SERVER_NAME] => 01.uccomponents.com
    [SERVER_ADDR] => 208.109.16.231
*/
fn_pre(json_decode($this->curl_response));
fn_pre($this->curl_info,1);


        $this->response->curl_ipv4=$os;
    }
        ...
        if ($this->input->source == "sku") {
            ...
            switch ($this->input->source) {
              ...
              default:
                ...
                $options['url_query']=$this->input->info;
                $options['url_query']=$this->input->varset;
            }
        }
    ...
    function html_lookup() {
        ...
        print "<td width='60%'>";
            ...
            print "</tr>";
       //     if (!preg_match("/^win/i", preg_quote(php_uname(),"/"))) {
                print "<tr class=lookup_debug>";
