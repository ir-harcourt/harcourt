...
class registry_ps_class extends registry_entry_class {
    ...
    function cad($update=FALSE) {
        global $database, $forms;
		$module_version=strtotime("02/28/2025");
	    if ($update) {
	        $database->registry->update(__FUNCTION__,"module_version",$module_version);
	        $database->registry->update(__FUNCTION__,"configurator",trim($_POST['cad_configurator']));
	        $database->registry->update(__FUNCTION__,"staging",trim($_POST['cad_staging']));
	        ...
	        $database->registry->update(__FUNCTION__,"partserver_staging",$_POST['cad_partserver_staging']);
            $database->registry->load(__FUNCTION__);
	        ...
	        $results[]="</tr>";
	        $results[]="<tr>";
	        $results[]="<td width='30%'>Configurator URL</td>";
	        $results[]="<td width='70%'>" . $forms->textarea("cad_configurator",$database->registry->cad->configurator,2,60) . "</td>";
	        $results[]="</tr>";
	        $results[]="<tr>";
	        $results[]="<td>Staging Configurator URL</td>";
	        $results[]="<td>" . $forms->textarea("cad_staging",$database->registry->cad->staging,2,60) . "</td>";
	        $results[]="</tr>";
	        $results[]="<tr>";
	        ...
	        $results[]="<tr><td colspan=2><br><b>PARTserver API</b></td></tr>";
	        $results[]="<tr>";
	        $results[]="<td width='30%'>&bull; Reverse map API</td>";
            $text=array();
	        ...
	        $results[]="</tr>";
	        $results[]="<tr>";
	        $results[]="<td width='30%'>&bull; Production URL</td>";
            $text=array();
	        ...
	        $results[]="</tr>";
	        $results[]="<tr>";
	        $results[]="<td width='30%'>&bull; Staging URL</td>";
            $text=array();
            $text[]="<br><i>Example: https://webassistants.qa.partcommunity.com/cgi-bin/cgi2pview.exe</i>";
            $text[]=$forms->textarea("cad_partserver_staging",$database->registry->cad->partserver_staging,2,60);
	        $results[]="<td width='70%'>" . implode("<br>",$text) . "</td>";
	        $results[]="</tr>";
