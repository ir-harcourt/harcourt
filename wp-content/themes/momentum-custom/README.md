# momentumst – A Bootstrap 4 Starter Theme, for WordPress

*Version 2.3*

[https://github.com/SimonPadbury/momentumst](https://github.com/SimonPadbury/momentumst)

------------------

**momentumst is a simple WordPress starter theme loaded with Bootstrap 4.**

Although momentumst was originally intended as a simple starter theme (hence the name momentumst), several people wanted child theme capability so with v2.0 I have made functions 'pluggable'. (It can still be used as a starter theme.)

## Features of momentumst
...
* **Navbar with dropdowns (child menus)** – a [custom walker nav menu class](https://github.com/SimonPadbury/momentumst/blob/master/functions/navbar.php) has been built to handle the dropdowns.
...
* A starter CSS theme – `/theme/css/momentumst.css`, enqueued. (Note: do not put your styles in `styles.css`, because that is not enqueued.)
...
## momentumst [Releases](https://github.com/SimonPadbury/momentumst/releases/)

Significant updates and milestones will be noted here: https://github.com/SimonPadbury/momentumst/releases/

## momentumst [Wiki](https://github.com/SimonPadbury/momentumst/wiki)

This is the place to find some answers: https://github.com/SimonPadbury/momentumst/wiki.

If you don't find what you want, please open an Issue.

If you want want to see something in `momentumst` and you can do it yourself, please feel at liberty to add it as a Pull Request. But remember that this is only meant to be a _starter_ theme – I don't want to add a load of stuff that most people will delete because they don't need it. There are other ways to expand the momentumst project – e.g. via the wiki.

---

## Meet momentumst's younger brother, m1st (Materiallize CSS starter theme for WordPress)
...
Progenitor started as momentumst but it has been developed to become somemething totally different. Progenitor is intended as a parent theme with pluggable functions, and hooks everywhere:
