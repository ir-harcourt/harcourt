...
if ( ! function_exists( 'momentumst_pagination' ) ) {
	function momentumst_pagination() {
		global $wp_query;
		...
		$paginate_links = paginate_links( array(
			...
			'mid_size' => 5,
			'prev_next' => True,
			'prev_text' => __('<i class="fas fa-angle-left"></i> Newer', 'momentumst'),
			'next_text' => __('Older <i class="fas fa-angle-right"></i>', 'momentumst'),
			'type' => 'list'
		) );
