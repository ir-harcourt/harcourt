...
class registry_entry_class {
	...
	function login($update=FALSE) {
	    global $database,$forms;
		$module_version=strtotime("08/21/2025");
	    if ($update) {
	        ...
	        $database->registry->update("login","pend_html",$_POST['login_pend_html']);
	        ...
	        $results[]="<tr>";
	        $results[]="<td>Set new users as <b>pending?</td>";
	        $results[]="<td>" . $forms->checkbox("login_pend",1,$database->registry->login->pend) . "</td>";
	        $results[]="</tr>";
	        $results[]="<tr>";
	        $results[]="<td>Pending user message</td>";
	        $results[]="<td>" . $forms->textarea("login_pend_html",$database->registry->login->pend_html, 2, 60) . "</td>";
	        $results[]="</tr>";
 	        $results[]="<tr>";
