...
class dashboard_class {
    ...
    function menu() {
	    ...
	    $menu_group->group("Customer Portal");
        ...
        if ($_SESSION['user']->portal_id) {
        	$database->portal->read($_SESSION['user']->portal_id);
 			if ( ($database->portal->meta->rows) && ($database->portal->data->active) ) $menu_group->item("Executive",$database->portal->data->name . " Portal","/customer_portal.php");
        }
