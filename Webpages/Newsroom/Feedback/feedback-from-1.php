...
$message = "First Name:" .$_POST['f-name'];
$message .= "\n---------------------------\n";
$message = "Name:" .$_POST['lname'];
$message .= "\n---------------------------\n";
$message .= "Email:" .$_POST['emailaddress'];
$message .= "\n---------------------------\n";
$message .= "Feedback:" .$_POST['comment'];

$fromheader = "From: feedback@harcourtind.com";

mail($to, $subject, $message, $fromheader);

echo "<div align='center' style='font-family:Calibri, Arial' style='color: #999' style='font-weight:bold' style='font-size:36'>Thank You!</div>";
...
<title>Harcourt - Feedback Form</title>
<link href="http://www.harcourtind.com/feedback-from-1.css" rel="stylesheet" type="text/css" />
...
<form action="<? echo $_SERVER['PHP_SELF']; ?>" method="post" name="mailform" id="mailform">
<table width="400" border="0">
  <tr>
    <th colspan="2" bgcolor="#E43145" scope="col"><span style="font-size:12px; font-weight:normal; color:#FFF">Please fill out the form below...</span></th>
    </tr>
  <tr>
  ...
  <tr>
    <th scope="row"><div align="right"><span style=" font-weight:normal; color:#999">Name:</span></div></th>
    <td><div align="left">
      <input name="lname" type="text" id="name" />
    </div></td>
  </tr>
  <tr>
    <th bgcolor="#CCCCCC" scope="row"><div align="right"></div></th>
    <td bgcolor="#CCCCCC"><div align="left"></div></td>
  </tr>
  <tr>
    <th scope="row"><div align="right"><span style=" font-weight:normal; color:#999">Email Address:</span></div></th>
    <td><div align="left">
  ...
  <tr>
    <th scope="row"><div align="right"><span style=" font-weight:normal; color:#999">Feedback:</span></div></th>
    <td><div align="left">
...
<a href="http://www.harcourtind.com/thank-you.html"><p><input name="Submit" type="submit" id="submit" value="Submit">
  </p></a>
</form>
